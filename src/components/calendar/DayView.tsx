    ...
    <div className="flex flex-col flex-1 overflow-auto">
      <div className="grid grid-cols-2 border-b">
        ...
        <div className="p-2 text-center">
          ...
          <div className="inline-flex items-center justify-center w-8 h-8 rounded-full text-sm mt-1 bg-primary text-primary-foreground">
                ...
                {getEventsForHour(hour).map(event => {
                  ...
                  return (
                    <div
                      ...
                      className={cn(
                        'absolute top-0 left-0 right-2 m-1 p-2 rounded-lg text-sm cursor-pointer soft-shadow',
                        event.recurring ? 'border-l-4 border-secondary' : '',
                        'bg-opacity-90 hover:bg-opacity-100 transition-all hover:translate-y-[-1px]'
                      )}
                      style={{
